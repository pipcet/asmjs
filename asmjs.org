...
* wasm support
wasm32 support is rudimentary. wasm64 support is severely outdated (and simulates 64-bit operations as 32-bit ones anyway; the wasm MVP will probably not contain 64-bit support).
...
*** TODO remove $trace code
*** TODO dynamic memory limit
*** TODO test "name" section
*** TODO drop pc0 argument for direct calls
...
*** TODO Use call_indirect rather than indcall
* unsorted
** multifile support
