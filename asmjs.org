...
* wasm support
wasm/wasm64 support is rudimentarily present, but currently *outdated*.
...
The software-visible PC is split into a function index in the upper 32 bits and a relative PC in the lower 32 bits.
...
*** TODO shorten uleb128s
*** TODO sleb128 vs uleb128
