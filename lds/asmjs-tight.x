...
SECTIONS
{
  ...
  .predata :
  {
    LONG(__secondary_init_array_start);
    LONG(__secondary_init_array_end);
    LONG(__secondary_fini_array_start);
    LONG(__secondary_fini_array_end);
  }
  /DISCARD/ : {
    *(.predata)
  }
  .data :
  {
    ...
    *(.secondary.bss)
    ...
    KEEP (*(.secondary.init_array EXCLUDE_FILE (*crtend.o *crtend?.o) .ctors))
    __secondary_init_array_end = .;
    __secondary_fini_array_start = .;
    __secondary_fini_array_end = .;
  }
  .bss :
  {
     *(COMMON)
