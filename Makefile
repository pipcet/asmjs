...
libc.wasm: build/wasm32/glibc.make wasm32-unknown-none/wasm32-unknown-none/lib/libc.so
	$(PWD)/bin/wasmify-wasm32-lib $(PWD)/wasm32-unknown-none/wasm32-unknown-none/lib/libc.so > $(PWD)/libc.wasm || rm $(PWD)/libc.wasm

ld.wasm: build/wasm32/glibc.make wasm32-unknown-none/wasm32-unknown-none/lib/ld.so.1
	$(PWD)/bin/wasmify-wasm32-lib $(PWD)/wasm32-unknown-none/wasm32-unknown-none/lib/ld.so.1 > $(PWD)/ld.wasm || rm $(PWD)/ld.wasm
