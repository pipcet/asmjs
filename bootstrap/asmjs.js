...
AsmJSThread.prototype.stop = function (reason)
{
    ...
    this.HEAP32[this.threadpage+40>>2] =
        reason;
...
{
    this.HEAP32[this.threadpage+64>>2] =
        initsp;
};
...
ThinThin.sbrk = function (size)
{
    ...
    if (this.HEAP32[4096+8>>2] >
        this.HEAP32[4096+0>>2]) {
        throw "OOM";
    }
...
if (typeof(os) !== "undefined" &&
    ...
    ThinThin.getdents = function (fdno, direntp, count)
    {
        if (first) {
            ...
            CStringTo(this.HEAP8, 19, "words.eng");
            first--;
            return 26;
        }
        return 0;
